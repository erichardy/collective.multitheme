...
var pyfiles = ['src/plonetheme/concertina/*.py', 'src/plonetheme/concertina/browser/*.py', 'src/plonetheme/concertina/browser/behaviors/*.py', 'src/plonetheme/concertina/browser/viewlets/*.py'];
...
gulp.task('docs', ['build-docs'], function() {
  ...
  gulp.watch(['./docs/*.rst', './docs/*.py', 'src/plonetheme/concertina/*.py', 'src/plonetheme/concertina/browser/*.py'], ['build-docs'])
})
 ...
 * # gulp less
 */
var lessfiles = ['src/collective/multitheme/theme/less/spot/*.less'];
